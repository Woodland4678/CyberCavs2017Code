...
package org.usfirst.frc4678.CyberCavs2017Code.commands;
...
public class RobotDrive extends Command {
	double joyStickX, joyStickY, leftPower, rightPower;
    ...
    protected void execute() {
		...
		SmartDashboard.putNumber("Left Wheels Position", Robot.driveTrain.getLeftEncoder());
		SmartDashboard.putNumber("Right Wheels Position", Robot.driveTrain.getRightEncoder());
    }
