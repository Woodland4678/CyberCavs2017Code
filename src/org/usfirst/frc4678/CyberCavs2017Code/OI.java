...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("SpinUpShooter", new SpinUpShooter());
        SmartDashboard.putData("Shoot", new Shoot());
        SmartDashboard.putData("Agitate", new Agitate());
        SmartDashboard.putData("ExpandHopper", new ExpandHopper());
        SmartDashboard.putData("RetractHopper", new RetractHopper());
